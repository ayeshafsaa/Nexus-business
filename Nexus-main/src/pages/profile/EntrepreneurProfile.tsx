  ...
  if (!entrepreneur || entrepreneur.role !== 'entrepreneur') {
    return (
      <div className="text-center py-12">
        ...
        {/* ← Updated back link — works for both investor dashboard and find page */}
        <Link to="/entrepreneurs">
          <Button variant="outline" className="mt-4">Back to Startups</Button>
        </Link>
      </div>
    );
  }
            ...
            <CardBody>
              <div className="space-y-3">
                {['Pitch Deck', 'Business Plan', 'Financial Projections'].map((doc, i) => (
                  <div key={i} className="flex items-center p-3 border border-gray-200 rounded-md hover:bg-gray-50 transition-colors">
