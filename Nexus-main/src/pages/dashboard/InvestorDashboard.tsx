...
import { Users, PieChart, Filter, Search, PlusCircle, Wallet, ArrowUpRight } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 animate-fade-in">
     ...
     <div data-tour="dashboard-stats" className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {/* Wallet Balance */}
        <Card data-tour="wallet-balance" className="bg-gradient-to-br from-violet-600 to-purple-700 border-0 shadow-lg shadow-violet-200">
          <CardBody>
            <div className="flex flex-col gap-2">
              <div className="flex items-center justify-between">
                <span className="text-violet-200 text-xs font-medium">Available to Invest</span>
              ...
              >
                <ArrowUpRight size={11} /> Fund a Deal →
              </Link>
            </div>
          </CardBody>
        </Card>
